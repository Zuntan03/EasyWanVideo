...
@REM SageAttention wheel cp310
@REM if not exist %EASY_TOOLS_DIR%\Python\Python_DefaultVersion.txt (
@REM 	echo 3.12.9> %EASY_TOOLS_DIR%\Python\Python_DefaultVersion.txt
@REM )
